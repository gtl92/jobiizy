...
if (currentScrollY < startStickyY) {
    ...
    'is-sticky',
    'widget-background-solid',
    'widget-background-clamped'
  );
...
function setFixedClamped(sidebarRect, cvFormLayoutTop) {
    ...
    widget.style.zIndex   = '9999';
     ...
     // ✅ état sticky: background opaque
  widget.classList.add('is-sticky', 'widget-background-solid');
  widget.classList.remove('widget-background-transparent');

  // ✅ état “fin de zone”: quand on est clampé (le widget commence à remonter)
  const isClamped = topClamped < TOP_OFFSET;
  widget.classList.toggle('widget-background-clamped', isClamped);
