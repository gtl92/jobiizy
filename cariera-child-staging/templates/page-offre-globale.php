...
<!-- ── Autocomplétion (même logique que page-emplois-refonte.php) ────────── -->
<script>
(function () {
  'use strict';
  ...
  function showDrop(drop) { drop.classList.add('show'); }
  function hideDrop(drop) { drop.classList.remove('show'); }
  ...
  document.addEventListener('click', function (e) {
    ...
    if (!drop) return;
    var inputId = drop.classList.contains('jobiizy-keywords-dropdown') ? 'jzog-keywords' : 'jzog-location';
    var input = document.getElementById(inputId);
    if (input) input.value = item.dataset.value || '';
    hideDrop(drop);
  });

  setupAC('jzog-keywords', '.jobiizy-keywords-dropdown', 'jobiizy_autocomplete_keywords',
  ...
  setupAC('jzog-location', '.jobiizy-location-dropdown', 'jobiizy_autocomplete_location',
