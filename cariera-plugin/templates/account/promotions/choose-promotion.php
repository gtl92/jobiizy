...
<div id="promotions-modal" class="small-dialog zoom-anim-dialog mfp-hide">
	...
	<div class="small-dialog-content">
		<div class="promo-packages-wrapper">
			...
			if ( ! empty( $products ) ) {
				?>
				<h2 class="title"><?php esc_html_e( 'Promotional Packages', 'cariera-core' ); ?></h2> 
							...
							<a href="#">
								...
								<div class="package-details">
									...
									<p>
										...
										printf( esc_html__( 'Promotion lasts for %s days', 'cariera-core' ), number_format_i18n( $product->get_duration() ) );
										?>
									</p>
								</div>
							</a>
			...
			<?php if ( empty( $products ) && empty( $packages ) ) { ?>
				<span><?php esc_html_e( 'There are no promotional packages available at the moment.', 'cariera-core' ); ?></span>
			<?php } ?>
		</div>
	</div>
</div>
