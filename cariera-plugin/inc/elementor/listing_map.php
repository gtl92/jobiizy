...
class Cariera_Listing_Map extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Listing Map', 'cariera-core' );
	}
		...
		$this->add_control(
			...
			[
				...
				'options'     => [
					...
					'resumes'     => esc_html__( 'Resumes', 'cariera-core' ),
				],
				'default'     => 'job_listing',
				'description' => esc_html__( 'The page must have listings from your selected listing type so that the map can grab their locations and add them into the map.', 'cariera-core' ),
			]
		);
		$this->add_control(
			'height',
