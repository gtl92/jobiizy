...
class Messages {
	...
	public function get_conversations() {
		...
		$lazy_load_limit = isset( $_POST['lazy_load_limit'] ) ? sanitize_text_field( wp_unslash( $_POST['lazy_load_limit'] ) ) : ''; // phpcs:ignore WordPress.Security.NonceVerification.Missing

		// Friend list with lazy load limit.
		if ( isset( $_POST['lazy_load_limit'] ) ) { // phpcs:ignore WordPress.Security.NonceVerification.Missing
	...
	public function get_messages() {
		...
		$form       = sanitize_text_field( wp_unslash( $_POST['from'] ) ); // phpcs:ignore WordPress.Security.NonceVerification.Missing
		...
		if ( isset( $_POST['lazy_load_range'] ) ) {
			...
			if ( isset( $_POST['listing_id'] ) && $_POST['listing_id'] != 0 ) {
				...
				foreach ( $query as $key => $value ) {
					$query[ $key ]->created_at = human_time_diff( strtotime( $value->created_at ), current_time( 'timestamp' ) ) . esc_html__( ' ago', 'cariera-core' );
		...
		} elseif ( isset( $_POST['listing_id'] ) && $_POST['listing_id'] != 0 ) {
	...
	public function send_message() {
		...
		$message_unique_id = sanitize_text_field( wp_unslash( $_POST['msg_uid'] ) ); // phpcs:ignore WordPress.Security.NonceVerification.Missing
		...
		*/
		if ( isset( $_POST['listing_id'] ) && ! empty( $_POST['listing_id'] ) ) { // phpcs:ignore WordPress.Security.NonceVerification.Missing
			...
			if ( $author_id == $from && $author_id == $to ) {
				return wp_send_json(
					[
						'status'  => 'error',
						'message' => esc_html__( 'You can not send a message to yourself!', 'cariera-core' ),
					]
				);
			}
	...
	public function delete_conversation() {
		// phpcs:ignore WordPress.Security.NonceVerification.Missing
		if ( ! isset( $_POST['delete_user_id'] ) && ! isset( $_POST['user_id'] ) ) {
			return;
		}

		global $wpdb;

		$user_id        = sanitize_text_field( wp_unslash( $_POST['user_id'] ) ); // phpcs:ignore WordPress.Security.NonceVerification.Missing
		$delete_user_id = sanitize_text_field( wp_unslash( $_POST['delete_user_id'] ) ); // phpcs:ignore WordPress.Security.NonceVerification.Missing
		$listing_id     = sanitize_text_field( wp_unslash( $_POST['listing_id'] ) ); // phpcs:ignore WordPress.Security.NonceVerification.Missing
	...
	public function block_user() {
		...
		$user_id       = sanitize_text_field( wp_unslash( $_POST['user_id'] ) ); // phpcs:ignore WordPress.Security.NonceVerification.Missing
		$block_user_id = sanitize_text_field( wp_unslash( $_POST['block_user_id'] ) ); // phpcs:ignore WordPress.Security.NonceVerification.Missing
	...
	public function unblock_user() {
		...
		$user_id         = sanitize_text_field( wp_unslash( $_POST['user_id'] ) ); // phpcs:ignore WordPress.Security.NonceVerification.Missing
		$unblock_user_id = sanitize_text_field( wp_unslash( $_POST['unblock_user_id'] ) ); // phpcs:ignore WordPress.Security.NonceVerification.Missing
	...
	public function check_user_block_status() {
		...
		$login_user    = sanitize_text_field( wp_unslash( $_POST['login_user'] ) ); // phpcs:ignore WordPress.Security.NonceVerification.Missing
		$selected_user = sanitize_text_field( wp_unslash( $_POST['selected_user'] ) ); // phpcs:ignore WordPress.Security.NonceVerification.Missing
	...
	public function user_search() {
		...
		$search = sanitize_text_field( wp_unslash( $_POST['user_search'] ) ); // phpcs:ignore WordPress.Security.NonceVerification.Missing
