...
function cariera_listing_promotion_package_product_type( $types ) {
	...
	if ( class_exists( 'WP_Job_Manager' ) ) {
		$types['job_promotion_package'] = esc_html__( 'Job Promotion Package', 'cariera-core' );
	}

	$types['company_promotion_package'] = esc_html__( 'Company Promotion Package', 'cariera-core' );

	if ( class_exists( 'WP_Resume_Manager' ) ) {
		$types['resume_promotion_package'] = esc_html__( 'Resume Promotion Package', 'cariera-core' );
	}
